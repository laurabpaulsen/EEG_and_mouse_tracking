...
filename =  str(SAVE_FOLDER) + 'behavioural/'+ str(V['ID']) + str(utc_time) + '.csv'
...
practise_path = str(SAVE_FOLDER) + 'trial_info/practisetrials.csv'
experimental_path = str(SAVE_FOLDER) + 'trial_info/experimentaltrials.csv'
